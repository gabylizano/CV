...
1. Coordinated the migration of a system used to store and manage all employee job and personal data. Analyzed data dictionaries and HR administrators' data usage to identify access and privacy requirements. Implemented a secure self-service model that restricted access to sensitive information while allowing employees to manage required personal data such as gender and religion. This approach strengthened data privacy controls and increased employee trust and satisfaction by ensuring their information was securely managed.
1. Created Program strategy, setting goals and driving of the implementation of Workforce Data Management Tool to enable administrators to effectively manage Amazon employee's data and provided support at scale.
1. Executed Change management for process improvement, new process set up, and transitions related to employees' Personal and Job Data domain.
1. Led special project intakes to close gaps on Employees'Personal and Job Data process support, reporting, and business continuity.
1. Delivered HR special projects at the highest levels of efficiency, focusing on reducing manual efforts by diving deep into New and/or existing Automation solutions with Amazon Tech & Product Partner teams to deliver frustration free experiences for stakeholders and customers.
...
1. Led the development of a custom automation solution that eliminated the need for InstallShield licensing to run scripts on client software solutions. Replaced paid licenses with a script-based package built using ADT and Visual Basic, enabling execution across multiple client environments without third-party tools. The successful implementation reduced reliance on software packagers, eliminating 15 licenses, and generated an estimated cost savings and revenue impact of approximately $170K.
1. Managed the Deskside Automation project by redesigning ServiceNow queue categorization to enable automated resolution based on issue type. Developed scripts that allowed packagers to deploy fixes to multiple clients simultaneously without direct machine access or user interaction. Solutions were automatically downloaded and executed based on the client's Office version, reducing the monthly ticket backlog from 300 to 10 and significantly improving operational efficiency. 
